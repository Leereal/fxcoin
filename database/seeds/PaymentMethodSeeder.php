...
class PaymentMethodSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        App\PaymentMethod::create(['name'=>'AFRICAN BANK  (SOUTH AFRICA)','avatar'=>'african_bank.png','currency_id'=>'2']);
        ...
        App\PaymentMethod::create(['name'=>'STANDARD (BOTSWANA)','avatar'=>'standard.png','currency_id'=>'2']);
        App\PaymentMethod::create(['name'=>'NEDBANK (NAMIBIA)','avatar'=>'nedbank.png','currency_id'=>'2']);
        App\PaymentMethod::create(['name'=>'STANDARD (NAMIBIA)','avatar'=>'standard.png','currency_id'=>'2']);
        ...
        App\PaymentMethod::create(['name'=>'STANDARD (SWAZILAND)','avatar'=>'standard.png','currency_id'=>'2']);
        App\PaymentMethod::create(['name'=>'FNB (SWAZILAND)','avatar'=>'fnb.png','currency_id'=>'2']);
        App\PaymentMethod::create(['name'=>'STANDARD (LESOTHO)','avatar'=>'standard.png','currency_id'=>'2']);
